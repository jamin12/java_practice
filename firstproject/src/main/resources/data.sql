...
insert into Comment(id,article_id,nickname,body) values (6,4,'choi','초밥');

----5번 게시글의 댓글들
insert into Comment(id,article_id,nickname,body) values (7,4,'Park','조깅');
insert into Comment(id,article_id,nickname,body) values (8,4,'kim','유트브');
